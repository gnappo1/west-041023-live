...
class Production(db.Model, SerializerMixin):
    ...
    crew_members = db.relationship('CrewMember', back_populates='production', cascade='all')
    # Define the fields to include in the serialized output
    # serialize_only = ('id', 'title', 'genre', 'crew_members')
...
class CrewMember(db.Model, SerializerMixin):
    ...
    # Define the fields to include in the serialized output
    # serialize_only = ('id', 'name', 'role', 'production')
