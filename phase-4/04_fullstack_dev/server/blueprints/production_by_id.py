from blueprints import request, Blueprint, make_response, g, abort, ValidationError, Resource
from models import db
from schemas.production_schema import ProductionSchema

production_schema = ProductionSchema()
production_by_id_bp = Blueprint('production_by_id', __name__, url_prefix='/productions/<int:id>')
